...
/*
Description:    Gets list of recent news items by publisher
Usage:         	dsp_NEWS_NewsItemSearchPublisher 0
...
CREATE PROCEDURE dbo.dsp_NEWS_NewsItemSearchPublisher(@UserID int,
					     	  @StartDate Datetime,
					          @EndDate Datetime)
AS 
...
GRANT  EXECUTE  ON dbo.dsp_NEWS_NewsItemSearchPublisher  TO [EnergyUser]
GO
